...
def main():
    ...
    if not width or not height:
        ...
        # Decide if you want to exit or continue without resolution
        # sys.exit("Exiting due to missing screen resolution.") 
    else:
    ...
    while True:
        ...
        # Add a small delay to prevent accidental double inputs 
        # and allow user to see action result on screen
        time.sleep(0.5) 
